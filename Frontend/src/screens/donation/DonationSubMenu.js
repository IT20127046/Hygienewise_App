...
export default function DonationSubMenu({ navigation }) {
    ...
    <ScrollView style={styles.scrollView} >
      ...
      <Card style={styles.card} onPress={() => navigation.navigate("ListOfDonation")}>
        <ImageBackground borderRadius={20} source={require('../../assets/images/MenuBackground.jpg')} style={styles.imageBackground}>
          <Card.Title title="List Of Donation"  />
        </ImageBackground>
      </Card>
      <Card style={styles.card} onPress={() => navigation.navigate("MyDonation")}>
        <ImageBackground borderRadius={20} source={require('../../assets/images/MenuBackground.jpg')} style={styles.imageBackground}>
          <Card.Title title="My Donations"  />
        </ImageBackground>
      </Card>
